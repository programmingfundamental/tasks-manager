...
public class ReportController {
    ...
    @GetMapping()
    public ResponseEntity<List<ReportResponseDto>> getByHoursWorkedFromDateCreatedToDateUpdated(@RequestParam Long hours, @Valid @RequestParam LocalDateTime from, @Valid @RequestParam LocalDateTime to) throws ResourceNotFoundException {
